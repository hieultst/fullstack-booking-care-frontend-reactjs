...
class BookingModal extends Component {
    ...
    render() {
        ...
        return (
            <>
                <LoadingOverlay
                    active={this.state.isLoadingGender}
                    spinner
                    text="Loading..."
                >
                    <Modal
                                ...
                                <div className="row">
                                    <div className="col-6 form-group">
                                        <label>
                                            <FormattedMessage
                                                id={
                                                    "patient.booking-modal.full-name"
                                                }
                                            />
                                        </label>
                                        <input
                                    ...
                                    <div className="col-6 form-group">
                                        <label>
                                            <FormattedMessage
                                                id={
                                                    "patient.booking-modal.phone-number"
                                                }
                                            />
                                        </label>
                                        <input
